...
1. **Simulador de Meta:** Calcula automaticamente a nota necessária na AP2 para atingir a média mínima de 7.0 e garantir a aprovação direta, sem necessidade de Prova Substitutiva (AS).
